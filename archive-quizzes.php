<?php
/**
 * The template for displaying the quizzes archive
 *
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
          <header class="entry-header">
            ...
            if ( is_singular() ) :
              ...
              // display the title that links to the quiz-maker page
              the_title( '<h2 class="entry-title"><a href="' . esc_url( get_field('quiz_link') ) . '" rel="bookmark" target="_blank">', '</a></h2>' );
            endif;
